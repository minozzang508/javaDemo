...
public class kakao_01 {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < n; i++) {
            arr1[i] = (int)(Math.random() * (2 << n - 1));
            arr2[i] = (int)(Math.random() * (2 << n - 1));
            res[i] = 0;
        }
        ...
        for(int i = 0; i < n; i++) {
//            for(int j = n; j > 0; j--) {
//                int tmp1 = (arr1[i] >> (j - 1)) - arr1[i] >> j;
//                int tmp2 = (arr2[i] >> (j - 1)) - arr2[i] >> j;
//
//                res[i] = (res[i] << 1) + (tmp1 | tmp2);
//            }
    ...
    static String[] showRes (int[] res, int n) {
        String[] resString = new String[n];
        String temp = "";


        for(int i = 0; i < n; i++) {
            temp = Integer.toBinaryString(res[i]);
            String s = "";
            for(int j = 0; j < n; j++){
                if(temp.charAt(j) == '1') {
                    s += "#";
